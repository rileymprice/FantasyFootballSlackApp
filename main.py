...
BOT_OAUTH_TOKEN = os.environ.get("SLACK_BOT_OAUTH_TOKEN")


slack_client = slack.WebClient(BOT_OAUTH_TOKEN)
bot_id = None

BOT_NAME = "fantasybot"
RTM_READ_DELAY = 1
EXAMPLE_COMMAND = "do"
MENTION_REGEX = f"^(@{BOT_NAME})"
ALAN_MENTION_REGEX = "[^a-zA-Z](alan)[^a-zA-Z]/i"
